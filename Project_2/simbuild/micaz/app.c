...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7fa29037b020, const void *arg_0x7fa29037b320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7fa2902f35e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fa2900963a0), 
int (*key_eq_fn)(void *arg_0x7fa290096b70, void *arg_0x7fa290096e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fa28fe02c00, int arg_0x7fa28fe02e80);
static double RandomUniform(void );
...
#line 91
              sim_log_debug(149U, HASHMAP_CHANNEL, "Moving %d to %d\n", j, j + 1);
              sim_log_debug(150U, HASHMAP_CHANNEL, "Replacing %d with %d\n", /*NodeC.neighbors*/HashmapC__0__keys[sim_node()][j], /*NodeC.neighbors*/HashmapC__0__keys[sim_node()][j + 1]);
              /*NodeC.neighbors*/HashmapC__0__keys[sim_node()][j] = /*NodeC.neighbors*/HashmapC__0__keys[sim_node()][j + 1];
            }
          ...
          sim_log_debug(151U, "hashmap", "Done removing entry\n");
          return;
        }
    }
}
...
#line 236
{
  ...
  if (Node__neighbors__contains(node) == 0 && timeStamp > 60000 * 5) {
      sim_log_debug(115U, NEIGHBOR_CHANNEL, "Neighbor %d is online", node);
      ...
      if (__nesc_ntoh_uint16(myMsg->dest.nxdata) != 0) {
          if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) != 2) {
              ...
              if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == TOS_NODE_ID && !Node__checkPackage(__nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->seq.nxdata))) {
                  sim_log_debug(110U, ROUTING_CHANNEL, "Packet destination reached. Payload: %s \n", myMsg->payload);
                  if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == 0) {



                      Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->src.nxdata), 18, 1, __nesc_ntoh_uint16(Node__sendPackage[sim_node()].seq.nxdata) + 1, "package here", PACKET_MAX_PAYLOAD_SIZE);
...
#line 111
                if (__nesc_ntoh_uint8(myMsg->TTL.nxdata) > 0 && !Node__checkPackage(__nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->seq.nxdata)) && __nesc_ntoh_uint16(myMsg->src.nxdata) != TOS_NODE_ID) {
                    sim_log_debug(111U, FLOODING_CHANNEL, "Flooding Network... \n");
...
#line 117
                  {
                    sim_log_debug(112U, FLOODING_CHANNEL, "Duplicate Packet\n");
                    return msg;
                  }
                }
            }
...
#line 121
  ...
  sim_log_debug(113U, GENERAL_CHANNEL, "Unknown Packet Type %d\n", len);
  return msg;
}
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7fa28faf2e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fa28faf2e30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7fa28faf2e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 91
              sim_log_debug(161U, HASHMAP_CHANNEL, "Moving %d to %d\n", j, j + 1);
              sim_log_debug(162U, HASHMAP_CHANNEL, "Replacing %d with %d\n", /*NodeC.packets*/HashmapC__2__keys[sim_node()][j], /*NodeC.packets*/HashmapC__2__keys[sim_node()][j + 1]);
              /*NodeC.packets*/HashmapC__2__keys[sim_node()][j] = /*NodeC.packets*/HashmapC__2__keys[sim_node()][j + 1];
            }
          ...
          sim_log_debug(163U, "hashmap", "Done removing entry\n");
          return;
        }
    }
}
...
#line 91
      ...
      sim_log_debug(180U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*NodeC.SimpleSendC.PoolC.PoolP*/PoolP__0__free[sim_node()]);
      return rval;
    }
  return (void *)0;
}
...
#line 91
              sim_log_debug(155U, HASHMAP_CHANNEL, "Moving %d to %d\n", j, j + 1);
              sim_log_debug(156U, HASHMAP_CHANNEL, "Replacing %d with %d\n", /*NodeC.activeNodes*/HashmapC__1__keys[sim_node()][j], /*NodeC.activeNodes*/HashmapC__1__keys[sim_node()][j + 1]);
              /*NodeC.activeNodes*/HashmapC__1__keys[sim_node()][j] = /*NodeC.activeNodes*/HashmapC__1__keys[sim_node()][j + 1];
            }
          ...
          sim_log_debug(157U, "hashmap", "Done removing entry\n");
          return;
        }
    }
}
...
#line 91
              sim_log_debug(167U, HASHMAP_CHANNEL, "Moving %d to %d\n", j, j + 1);
              sim_log_debug(168U, HASHMAP_CHANNEL, "Replacing %d with %d\n", /*NodeC.updates*/HashmapC__3__keys[sim_node()][j], /*NodeC.updates*/HashmapC__3__keys[sim_node()][j + 1]);
              /*NodeC.updates*/HashmapC__3__keys[sim_node()][j] = /*NodeC.updates*/HashmapC__3__keys[sim_node()][j + 1];
            }
          ...
          sim_log_debug(169U, "hashmap", "Done removing entry\n");
          return;
        }
    }
}
...
#line 42
  ...
  if (k == /*NodeC.activeNodes*/HashmapC__1__EMPTY_KEY[sim_node()]) {
      sim_log_debug(152U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*NodeC.activeNodes*/HashmapC__1__EMPTY_KEY[sim_node()]);
      return;
    }
...
#line 42
  ...
  if (k == /*NodeC.updates*/HashmapC__3__EMPTY_KEY[sim_node()]) {
      sim_log_debug(164U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*NodeC.updates*/HashmapC__3__EMPTY_KEY[sim_node()]);
      return;
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7fa28faf1a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7fa28faf1a50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7fa28fb0cc70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7fa28fb0cc70, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7fa28f3a9b60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7fa28f3a9b60, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(173U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] >= 1) {
      ...
      sim_log_debug(174U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(175U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(176U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
...
#line 133
        {
          ...
          sim_log_debug(170U, GENERAL_CHANNEL, "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 138
    {
      sim_log_debug(171U, GENERAL_CHANNEL, "The radio is busy");
      return EBUSY;
    }


  sim_log_debug(172U, GENERAL_CHANNEL, "FAILED!?");
  return FAIL;
}
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7fa28f3aa940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fa28f3aa940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7fa28f3aa940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 91
  sim_log_debug(206U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*CommandHandlerC.QueueC*/QueueC__0__size[sim_node()]);
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      sim_log_debug(189U, COMMAND_CHANNEL, "A Command has been Issued.\n");
      ...
      switch (commandID) {
          ...
          case CMD_PING: 
            sim_log_debug(190U, COMMAND_CHANNEL, "Command Type: Ping\n");
          CommandHandlerP__CommandHandler__ping(buff[0], &buff[1]);
          break;

          case CMD_NEIGHBOR_DUMP: 
            sim_log_debug(191U, COMMAND_CHANNEL, "Command Type: Neighbor Dump\n");
          CommandHandlerP__CommandHandler__printNeighbors();
          break;

          case CMD_LINKSTATE_DUMP: 
            sim_log_debug(192U, COMMAND_CHANNEL, "Command Type: Link State Dump\n");
          CommandHandlerP__CommandHandler__printLinkState();
          break;

          case CMD_ROUTETABLE_DUMP: 
            sim_log_debug(193U, COMMAND_CHANNEL, "Command Type: Route Table Dump\n");
          CommandHandlerP__CommandHandler__printRouteTable();
          break;

          case CMD_TEST_CLIENT: 
            sim_log_debug(194U, COMMAND_CHANNEL, "Command Type: Client\n");
          CommandHandlerP__CommandHandler__setTestClient();
          break;

          case CMD_TEST_SERVER: 
            sim_log_debug(195U, COMMAND_CHANNEL, "Command Type: Client\n");
          CommandHandlerP__CommandHandler__setTestServer();
          break;

          default: 
            sim_log_debug(196U, COMMAND_CHANNEL, "CMD_ERROR: \"%d\" does not match any known commands.\n", __nesc_ntoh_uint8(msg->id.nxdata));
          break;
        }
      CommandHandlerP__Pool__put(raw_msg);
    }
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7fa28fcd6020){
#line 75
  switch (arg_0x7fa28fcd6020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7fa28fcd6020);
#line 75
      break;
#line 75
    }
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7fa28f534950){
#line 83
  switch (arg_0x7fa28f534950) {
#line 83
    case 0U:
#line 83
      Node__ntimer__fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7fa28f534950);
#line 83
      break;
#line 83
    }
...
#line 64
{
  ...
  Node__AMControl__start();
  Node__ntimer__startPeriodic(60000);
...
#line 76
  sim_log_debug(201U, "QueueC", "head <-");
...
#line 81
          sim_log_debug_clear(203U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(204U, "QueueC", "] ");
    }
  sim_log_debug_clear(205U, "QueueC", "<- tail\n");
}
...
#line 42
  ...
  if (k == /*NodeC.packets*/HashmapC__2__EMPTY_KEY[sim_node()]) {
      sim_log_debug(158U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*NodeC.packets*/HashmapC__2__EMPTY_KEY[sim_node()]);
      return;
    }
...
#line 327
{
  ...
  if (dist == 1) {
      sim_log_debug(117U, NEIGHBOR_CHANNEL, "Node %d is now active. Adding to Link State\n", dest);
      Node__activeNodes__insert(dest, dest);
      Node__updates__insert(src, seq);
    }
  else 
    {
      sim_log_debug(118U, NEIGHBOR_CHANNEL, "Removing Node %d from active list and LinkState. Sequence Reset \n", dest);
...
#line 42
  ...
  if (k == /*NodeC.neighbors*/HashmapC__0__EMPTY_KEY[sim_node()]) {
      sim_log_debug(146U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*NodeC.neighbors*/HashmapC__0__EMPTY_KEY[sim_node()]);
      return;
    }
...
#line 293
{
  ...
  for (i = 0; i < neighborIndex; i++) {
      ...
      if (currentTS - nodeTS > 180000) {
          sim_log_debug(116U, NEIGHBOR_CHANNEL, "Neighbor %d is offline", neighborKeys[i]);
