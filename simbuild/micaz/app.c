...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7f1be9bf9020, const void *arg_0x7f1be9bf9320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7f1be9b715e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f1be99143a0), 
int (*key_eq_fn)(void *arg_0x7f1be9914b70, void *arg_0x7f1be9914e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f1be9701c00, int arg_0x7f1be9701e80);
static double RandomUniform(void );
...
#line 91
              sim_log_debug(139U, HASHMAP_CHANNEL, "Moving %d to %d\n", j, j + 1);
              sim_log_debug(140U, HASHMAP_CHANNEL, "Replacing %d with %d\n", /*NodeC.neighbors*/HashmapC__0__keys[sim_node()][j], /*NodeC.neighbors*/HashmapC__0__keys[sim_node()][j + 1]);
              /*NodeC.neighbors*/HashmapC__0__keys[sim_node()][j] = /*NodeC.neighbors*/HashmapC__0__keys[sim_node()][j + 1];
            }
          ...
          sim_log_debug(141U, "hashmap", "Done removing entry\n");
          return;
        }
    }
}
...
#line 360
  ...
  if (Node__neighbors__contains(node) == 0 && timeStamp > 4000 * 5) {
      sim_log_debug(120U, NEIGHBOR_CHANNEL, "Neighbor %d is online", node);
...
#line 610
  ...
  sim_log_debug(134U, TRANSPORT_CHANNEL, "TCP Data recieved\n");
...
#line 523
  ...
  switch (__nesc_ntoh_uint8(msg->flag.nxdata)) {
      case SYN_FLAG: 
        sim_log_debug(124U, TRANSPORT_CHANNEL, "SYN flag arrived\n");
      if (socket == (void *)0) {
          sim_log_debug(125U, TRANSPORT_CHANNEL, "Socket not found\n");
        }
      if (socket->state == CLOSED) {
          sim_log_debug(126U, TRANSPORT_CHANNEL, "Closed Socket recieved SYN\n");
          ...
          socket->prevPack = Node__sendPackage[sim_node()];
          sim_log_debug(127U, TRANSPORT_CHANNEL, "ACK sent\n");
        }
      break;


      case ACK_FLAG: 
        sim_log_debug(128U, TRANSPORT_CHANNEL, "ACK FLAG recieved \n");
      if (socket->state == SYN_SENT) {
          sim_log_debug(129U, TRANSPORT_CHANNEL, "Setting socket to established\n");
          ...
          Node__Sender__send(Node__sendPackage[sim_node()], Node__hopCount(__nesc_ntoh_uint16(myMsg->src.nxdata)));
          socket->prevPack = Node__sendPackage[sim_node()];
          sim_log_debug(130U, TRANSPORT_CHANNEL, "ACK sent\n");
        }
      ...
      if (socket->state == ESTABLISHED) {
          ...
          for (i = 0; i < WINDOWSIZE; i++) {
              if (socket->outstandPacks[i] == __nesc_ntoh_uint16(myMsg->seq.nxdata)) {
                  sim_log_debug(131U, TRANSPORT_CHANNEL, "ACK recieved for packet. remove from queue\n");
      ...
      case FIN_FLAG: 
        sim_log_debug(132U, TRANSPORT_CHANNEL, "FIN: Channel will now close....printing sent data\n");
      for (i = 0; i < socket->lastRcvd; i++) {
          printf("%c\n", socket->rcvdBuff[i]);
        }

      sim_log_debug(133U, TRANSPORT_CHANNEL, "Finished Printing\n");
      socket->state = CLOSED;
      break;
    }
}
...
#line 61
# 102 "lib/modules/CommandHandlerP.nc"
static inline message_t *CommandHandlerP__Receive__receive(message_t *raw_msg, void *payload, uint8_t len)
#line 102
{
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f1be93e5e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f1be93e5e30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f1be93e5e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 91
              sim_log_debug(151U, HASHMAP_CHANNEL, "Moving %d to %d\n", j, j + 1);
              sim_log_debug(152U, HASHMAP_CHANNEL, "Replacing %d with %d\n", /*NodeC.packets*/HashmapC__2__keys[sim_node()][j], /*NodeC.packets*/HashmapC__2__keys[sim_node()][j + 1]);
              /*NodeC.packets*/HashmapC__2__keys[sim_node()][j] = /*NodeC.packets*/HashmapC__2__keys[sim_node()][j + 1];
            }
          ...
          sim_log_debug(153U, "hashmap", "Done removing entry\n");
          return;
        }
    }
}
...
#line 91
      ...
      sim_log_debug(197U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*NodeC.SimpleSendC.PoolC.PoolP*/PoolP__0__free[sim_node()]);
      return rval;
    }
  return (void *)0;
}
...
#line 91
              sim_log_debug(145U, HASHMAP_CHANNEL, "Moving %d to %d\n", j, j + 1);
              sim_log_debug(146U, HASHMAP_CHANNEL, "Replacing %d with %d\n", /*NodeC.activeNodes*/HashmapC__1__keys[sim_node()][j], /*NodeC.activeNodes*/HashmapC__1__keys[sim_node()][j + 1]);
              /*NodeC.activeNodes*/HashmapC__1__keys[sim_node()][j] = /*NodeC.activeNodes*/HashmapC__1__keys[sim_node()][j + 1];
            }
          ...
          sim_log_debug(147U, "hashmap", "Done removing entry\n");
          return;
        }
    }
}
...
#line 91
              sim_log_debug(157U, HASHMAP_CHANNEL, "Moving %d to %d\n", j, j + 1);
              sim_log_debug(158U, HASHMAP_CHANNEL, "Replacing %d with %d\n", /*NodeC.updates*/HashmapC__3__keys[sim_node()][j], /*NodeC.updates*/HashmapC__3__keys[sim_node()][j + 1]);
              /*NodeC.updates*/HashmapC__3__keys[sim_node()][j] = /*NodeC.updates*/HashmapC__3__keys[sim_node()][j + 1];
            }
          ...
          sim_log_debug(159U, "hashmap", "Done removing entry\n");
          return;
        }
    }
}
...
#line 42
  ...
  if (k == /*NodeC.activeNodes*/HashmapC__1__EMPTY_KEY[sim_node()]) {
      sim_log_debug(142U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*NodeC.activeNodes*/HashmapC__1__EMPTY_KEY[sim_node()]);
      return;
    }
...
#line 42
  ...
  if (k == /*NodeC.updates*/HashmapC__3__EMPTY_KEY[sim_node()]) {
      sim_log_debug(154U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*NodeC.updates*/HashmapC__3__EMPTY_KEY[sim_node()]);
      return;
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f1be93e4a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f1be93e4a50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f1be93ffc70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f1be93ffc70, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f1be8bf14d0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f1be8bf14d0, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(190U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] >= 1) {
      ...
      sim_log_debug(191U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(192U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(193U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
...
#line 133
        {
          ...
          sim_log_debug(187U, GENERAL_CHANNEL, "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 138
    {
      sim_log_debug(188U, GENERAL_CHANNEL, "The radio is busy");
      return EBUSY;
    }


  sim_log_debug(189U, GENERAL_CHANNEL, "FAILED!?");
  return FAIL;
}
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f1be8bf22a0, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f1be8bf22a0) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f1be8bf22a0, msg, error);
#line 100
      break;
#line 100
    }
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      sim_log_debug(206U, COMMAND_CHANNEL, "A Command has been Issued.\n");
      ...
      switch (commandID) {
          ...
          case CMD_PING: 
            sim_log_debug(207U, COMMAND_CHANNEL, "Command Type: Ping\n");
          CommandHandlerP__CommandHandler__ping(buff[0], &buff[1]);
          break;

          case CMD_NEIGHBOR_DUMP: 
            sim_log_debug(208U, COMMAND_CHANNEL, "Command Type: Neighbor Dump\n");
          CommandHandlerP__CommandHandler__printNeighbors();
          break;

          case CMD_LINKSTATE_DUMP: 
            sim_log_debug(209U, COMMAND_CHANNEL, "Command Type: Link State Dump\n");
          CommandHandlerP__CommandHandler__printLinkState();
          break;

          case CMD_ROUTETABLE_DUMP: 
            sim_log_debug(210U, COMMAND_CHANNEL, "Command Type: Route Table Dump\n");
          CommandHandlerP__CommandHandler__printRouteTable();
          break;

          case CMD_TEST_CLIENT: 
            sim_log_debug(211U, COMMAND_CHANNEL, "Command Type: Client\n");
          data = buff[3];
          data = data | (buff[4] << 8);
          ...
          case CMD_TEST_SERVER: 
            sim_log_debug(212U, COMMAND_CHANNEL, "Command Type: Server\n");
          CommandHandlerP__CommandHandler__setTestServer(buff[0]);
          break;

          case CMD_END_CONNECTION: 
            sim_log_debug(213U, COMMAND_CHANNEL, "Command Type: End Connection\n");

          CommandHandlerP__CommandHandler__endConnection(buff[0], buff[1], buff[2]);
          break;

          default: 
            sim_log_debug(214U, COMMAND_CHANNEL, "CMD_ERROR: \"%d\" does not match any known commands.\n", __nesc_ntoh_uint8(msg->id.nxdata));
          break;
        }
      CommandHandlerP__Pool__put(raw_msg);
    }
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f1be95d5020){
#line 75
  switch (arg_0x7f1be95d5020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f1be95d5020);
#line 75
      break;
#line 75
    }
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f1be8d0d950){
#line 83
  switch (arg_0x7f1be8d0d950) {
#line 83
    case 0U:
#line 83
      Node__ntimer__fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f1be8d0d950);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(186U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP__compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP__overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(185U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP__overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(182U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(183U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(175U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(165U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(172U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(177U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 42
  ...
  if (k == /*NodeC.packets*/HashmapC__2__EMPTY_KEY[sim_node()]) {
      sim_log_debug(148U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*NodeC.packets*/HashmapC__2__EMPTY_KEY[sim_node()]);
      return;
    }
...
#line 285
  ...
  sim_log_debug(174U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(180U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 444
{
  ...
  if (dist == 1) {
      sim_log_debug(122U, NEIGHBOR_CHANNEL, "Node %d is now active. Adding to Link State\n", dest);
      Node__activeNodes__insert(dest, dest);
      Node__updates__insert(src, seq);
    }
  else 
    {
      sim_log_debug(123U, NEIGHBOR_CHANNEL, "Removing Node %d from active list and LinkState. Sequence Reset \n", dest);
...
#line 42
  ...
  if (k == /*NodeC.neighbors*/HashmapC__0__EMPTY_KEY[sim_node()]) {
      sim_log_debug(136U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*NodeC.neighbors*/HashmapC__0__EMPTY_KEY[sim_node()]);
      return;
    }
...
#line 410
{
  ...
  for (i = 0; i < neighborIndex; i++) {
      ...
      if (currentTS - nodeTS > 12000) {
          sim_log_debug(121U, NEIGHBOR_CHANNEL, "Neighbor %d is offline", neighborKeys[i]);
...
#line 101
      ...
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) {
              ...
              sim_log_debug(162U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
...
#line 463
{
  sim_log_debug(181U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(184U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(173U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
