...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7fcbf2481020, const void *arg_0x7fcbf2481320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7fcbf23f95e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fcbf219c3a0), 
int (*key_eq_fn)(void *arg_0x7fcbf219cb70, void *arg_0x7fcbf219ce30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fcbf1f89c00, int arg_0x7fcbf1f89e80);
static double RandomUniform(void );
...
uint16_t Node__recievedSeq[1000][100];
uint16_t Node__recievedSrc[1000][100];

int Node__neighbors[1000][15];
int Node__neighborCount[1000];
int Node__recievedCount[1000];

static inline bool Node__checkPackage(uint16_t src, uint16_t seq);
static inline void Node__addNeighbor(uint16_t node);
...
#line 224
{
  ...
  for (i = 0; i < 15; i++) {
      if (node == Node__neighbors[sim_node()][i]) {
          found = found + 1;
        }
    }

  if (found == 0) {
      Node__neighbors[sim_node()][Node__neighborCount[sim_node()]] = node;
      Node__neighborCount[sim_node()] = Node__neighborCount[sim_node()] + 1;
    }
}
...
#line 242
  for (i = 0; i < 100; i++) {
      if (src == Node__recievedSrc[sim_node()][i] && seq == Node__recievedSeq[sim_node()][i]) {
          return TRUE;
        }
    }

  Node__recievedSrc[sim_node()][Node__recievedCount[sim_node()]] = src;
  Node__recievedSeq[sim_node()][Node__recievedCount[sim_node()]] = seq;


  if (Node__recievedCount[sim_node()] != 99) {
      Node__recievedCount[sim_node()] = Node__recievedCount[sim_node()] + 1;
    }
  else 
#line 254
    {
      Node__recievedCount[sim_node()] = 0;
    }
...
#line 99
{
  ...
  if (len == sizeof(pack )) {
      ...
      if (__nesc_ntoh_uint16(myMsg->dest.nxdata) != 0) {
          sim_log_debug(110U, FLOODING_CHANNEL, "Package sent from: %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata));
          sim_log_debug(111U, FLOODING_CHANNEL, "Package Sequence number: %d\n", __nesc_ntoh_uint16(myMsg->seq.nxdata));
          sim_log_debug(112U, FLOODING_CHANNEL, "Package TTL: %d\n", __nesc_ntoh_uint8(myMsg->TTL.nxdata));

          if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == TOS_NODE_ID) {
              sim_log_debug(113U, FLOODING_CHANNEL, "Package destination has been reached!\n");
            ...
            if (__nesc_ntoh_uint8(myMsg->TTL.nxdata) > 0 && !Node__checkPackage(__nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->seq.nxdata)) && __nesc_ntoh_uint16(myMsg->src.nxdata) != TOS_NODE_ID) {
                sim_log_debug(114U, FLOODING_CHANNEL, "Currently Flooding....\n");

                Node__makePack(&Node__sendPackage[sim_node()], __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata), __nesc_ntoh_uint8(myMsg->TTL.nxdata) - 1, 0, __nesc_ntoh_uint16(myMsg->seq.nxdata), myMsg->payload, PACKET_MAX_PAYLOAD_SIZE);
                ...
                sim_log_debug(115U, FLOODING_CHANNEL, "TTL means termination / This is a duplicate package!\n");
                return msg;
              }
            }
        }
...
#line 75
{
  sim_log_debug(172U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*CommandHandlerC.PoolC.PoolP*/PoolP__1__free[sim_node()]);
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7fcbf1c7ae30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fcbf1c7ae30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7fcbf1c7ae30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 91
      ...
      sim_log_debug(155U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*NodeC.SimpleSendC.PoolC.PoolP*/PoolP__0__free[sim_node()]);
      return rval;
    }
  return (void *)0;
}
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7fcbf1c79a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7fcbf1c79a50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7fcbf1c94c70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7fcbf1c94c70, msg, error);
#line 110
}
#line 110
...
#line 109
      ...
      /*NodeC.SimpleSendC.PoolC.PoolP*/PoolP__0__free[sim_node()]++;
      sim_log_debug(156U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*NodeC.SimpleSendC.PoolC.PoolP*/PoolP__0__free[sim_node()]);
      return SUCCESS;
    }
}
...
#line 91
  sim_log_debug(162U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*NodeC.SimpleSendC.QueueC*/QueueC__1__size[sim_node()]);
...
#line 88
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7fcbf16124d0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7fcbf16124d0, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(148U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] >= 1) {
      ...
      sim_log_debug(149U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(150U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(151U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
...
#line 133
        {
          ...
          sim_log_debug(145U, GENERAL_CHANNEL, "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 138
    {
      sim_log_debug(146U, GENERAL_CHANNEL, "The radio is busy");
      return EBUSY;
    }


  sim_log_debug(147U, GENERAL_CHANNEL, "FAILED!?");
  return FAIL;
}
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7fcbf16132a0, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fcbf16132a0) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7fcbf16132a0, msg, error);
#line 100
      break;
#line 100
    }
...
#line 180
  ...
  for (i = 0; i < 15; i++) {
      if (Node__neighbors[sim_node()][i] > 0) {
          printf("Neighbor (%d) is: %d\n", i, Node__neighbors[sim_node()][i]);
        }
      else 
...
#line 161
{
  ...
  Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, destination, 19, 0, __nesc_ntoh_uint16(Node__sendPackage[sim_node()].seq.nxdata) + 1, payload, PACKET_MAX_PAYLOAD_SIZE);
  Node__Sender__send(Node__sendPackage[sim_node()], AM_BROADCAST_ADDR);
}
...
#line 91
  sim_log_debug(181U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*CommandHandlerC.QueueC*/QueueC__0__size[sim_node()]);
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      sim_log_debug(164U, COMMAND_CHANNEL, "A Command has been Issued.\n");
      ...
      switch (commandID) {
          ...
          case CMD_PING: 
            sim_log_debug(165U, COMMAND_CHANNEL, "Command Type: Ping\n");
          CommandHandlerP__CommandHandler__ping(buff[0], &buff[1]);
          break;

          case CMD_NEIGHBOR_DUMP: 
            sim_log_debug(166U, COMMAND_CHANNEL, "Command Type: Neighbor Dump\n");
          CommandHandlerP__CommandHandler__printNeighbors();
          break;

          case CMD_LINKSTATE_DUMP: 
            sim_log_debug(167U, COMMAND_CHANNEL, "Command Type: Link State Dump\n");
          CommandHandlerP__CommandHandler__printLinkState();
          break;

          case CMD_ROUTETABLE_DUMP: 
            sim_log_debug(168U, COMMAND_CHANNEL, "Command Type: Route Table Dump\n");
          CommandHandlerP__CommandHandler__printRouteTable();
          break;

          case CMD_TEST_CLIENT: 
            sim_log_debug(169U, COMMAND_CHANNEL, "Command Type: Client\n");
          CommandHandlerP__CommandHandler__setTestClient();
          break;

          case CMD_TEST_SERVER: 
            sim_log_debug(170U, COMMAND_CHANNEL, "Command Type: Client\n");
          CommandHandlerP__CommandHandler__setTestServer();
          break;

          default: 
            sim_log_debug(171U, COMMAND_CHANNEL, "CMD_ERROR: \"%d\" does not match any known commands.\n", __nesc_ntoh_uint8(msg->id.nxdata));
          break;
        }
      CommandHandlerP__Pool__put(raw_msg);
    }
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7fcbf1e5d020){
#line 75
  switch (arg_0x7fcbf1e5d020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7fcbf1e5d020);
#line 75
      break;
#line 75
    }
...
#line 168
{
  ...
  Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, 0, 0, 0, 0, "Timer", PACKET_MAX_PAYLOAD_SIZE);

  Node__neighborCount[sim_node()] = 0;
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7fcbf1728950){
#line 83
  switch (arg_0x7fcbf1728950) {
#line 83
    case 0U:
#line 83
      Node__ntimer__fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7fcbf1728950);
#line 83
      break;
#line 83
    }
...
#line 65
{
  ...
  Node__AMControl__start();
  Node__ntimer__startPeriodic(6000);
...
#line 76
  sim_log_debug(176U, "QueueC", "head <-");
  for (i = /*CommandHandlerC.QueueC*/QueueC__0__head[sim_node()]; i < /*CommandHandlerC.QueueC*/QueueC__0__head[sim_node()] + /*CommandHandlerC.QueueC*/QueueC__0__size[sim_node()]; i++) {
      sim_log_debug_clear(177U, "QueueC", "[");
...
#line 81
          sim_log_debug_clear(178U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(179U, "QueueC", "] ");
    }
  sim_log_debug_clear(180U, "QueueC", "<- tail\n");
}
...
#line 76
  sim_log_debug(157U, "QueueC", "head <-");
  for (i = /*NodeC.SimpleSendC.QueueC*/QueueC__1__head[sim_node()]; i < /*NodeC.SimpleSendC.QueueC*/QueueC__1__head[sim_node()] + /*NodeC.SimpleSendC.QueueC*/QueueC__1__size[sim_node()]; i++) {
      sim_log_debug_clear(158U, "QueueC", "[");
...
#line 81
          sim_log_debug_clear(159U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(160U, "QueueC", "] ");
    }
  sim_log_debug_clear(161U, "QueueC", "<- tail\n");
}
...
#line 109
      ...
      /*CommandHandlerC.PoolC.PoolP*/PoolP__1__free[sim_node()]++;
      sim_log_debug(175U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*CommandHandlerC.PoolC.PoolP*/PoolP__1__free[sim_node()]);
      return SUCCESS;
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "Node__recievedSeq"))
  {
    *addr = (uintptr_t)&Node__recievedSeq[__nesc_mote];
    *size = sizeof(Node__recievedSeq[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Node__recievedSrc"))
  {
    *addr = (uintptr_t)&Node__recievedSrc[__nesc_mote];
    *size = sizeof(Node__recievedSrc[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "Node__neighborCount"))
  {
    *addr = (uintptr_t)&Node__neighborCount[__nesc_mote];
    *size = sizeof(Node__neighborCount[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Node__recievedCount"))
  {
    *addr = (uintptr_t)&Node__recievedCount[__nesc_mote];
    *size = sizeof(Node__recievedCount[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&Node__recievedSeq[__nesc_mote], 0, sizeof Node__recievedSeq[__nesc_mote]);
  memset((void *)&Node__recievedSrc[__nesc_mote], 0, sizeof Node__recievedSrc[__nesc_mote]);
  memset((void *)&Node__neighbors[__nesc_mote], 0, sizeof Node__neighbors[__nesc_mote]);
  memset((void *)&Node__neighborCount[__nesc_mote], 0, sizeof Node__neighborCount[__nesc_mote]);
  Node__recievedCount[__nesc_mote] = 0;
